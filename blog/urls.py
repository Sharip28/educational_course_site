...
urlpatterns = [
    ...
    path('favorite-blog/<int:pk>/', favorite_blog, name='favorite_blog'),
    path('favorites/', blog_favorite_list, name='blog_favorite_list'),
    path('likes/<int:pk>/',likeblog,name='like_blog')
